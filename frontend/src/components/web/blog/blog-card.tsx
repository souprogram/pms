...
const BlogCardHeader = ({
  ...
  return (
    <Link to={href} className="w-fit">
      <h3 className="hover:text-primary decoration-primary line-clamp-2 text-base sm:text-lg font-semibold text-balance hyphens-auto decoration-3 underline-offset-4 transition">
        {children}
      </h3>
    </Link>
  );
